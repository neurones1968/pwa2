(function(global, factory) {
  typeof exports === "object" && typeof module !== "undefined"
    ? factory(exports, require("localforage"))
    : typeof define === "function" && define.amd
      ? define(["exports", "localforage"], factory)
      : factory(
          (global.localforageSetItems = global.localforageSetItems || {}),
          global.localforage
        );
        ...
        .then(function(serializer) {
          ...
          dbInfo.db.transaction(
            function(t) {
              ...
              var itemPromises = forEachItem(items, keyFn, valueFn, function(
                key,
                value
              ) {
                return new Promise(function(resolve, reject) {
