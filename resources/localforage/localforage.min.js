        ...
        function(a, b, c) {
          ...
          function e() {
            return "undefined" != typeof indexedDB
              ? indexedDB
              : "undefined" != typeof webkitIndexedDB
                ? webkitIndexedDB
                : "undefined" != typeof mozIndexedDB
                  ? mozIndexedDB
                  : "undefined" != typeof OIndexedDB
                    ? OIndexedDB
                    : "undefined" != typeof msIndexedDB
                      ? msIndexedDB
                      : void 0;
          }
          function f() {
                ...
                (f.onupgradeneeded = function(b) {
                  ...
                  try {
                    c.createObjectStore(a.storeName),
                      b.oldVersion <= 1 && c.createObjectStore(ja);
                  } catch (c) {
          ...
          function I(a) {
            ...
            for (b = 0; b < c.length; b += 3)
              (d += ma[c[b] >> 2]),
                (d += ma[((3 & c[b]) << 4) | (c[b + 1] >> 4)]),
                (d += ma[((15 & c[b + 1]) << 2) | (c[b + 2] >> 6)]),
                (d += ma[63 & c[b + 2]]);
            return (
              c.length % 3 === 2
            ...
            if (
              ...
              a &&
                ("[object ArrayBuffer]" === c ||
                  (a.buffer && "[object ArrayBuffer]" === Da.call(a.buffer))))
            ) {
              var d,
                e = pa;
          ...
          var Na =
            ...
            Oa = (function() {
              function a(b) {
                d(this, a),
                  (this.INDEXEDDB = Ia.INDEXEDDB),
                  (this.LOCALSTORAGE = Ia.LOCALSTORAGE),
                  (this.WEBSQL = Ia.WEBSQL),
                  (this._defaultConfig = ca({}, La)),
                  (this._config = ca({}, this._defaultConfig, b)),
              ...
              return (
                (a.prototype.config = function(a) {
                  if (
                    "object" === ("undefined" == typeof a ? "undefined" : ea(a))
                  ) {
                    if (this._ready)
                      return new Error(
                ...
                (a.prototype.defineDriver = function(a, b, c) {
                  var d = new ia(function(b, c) {
                    try {
                      ...
                      for (
                        var g = Ka.concat("_initStorage"), h = 0;
                        h < g.length;
                        h++
                      ) {
                        var i = g[h];
